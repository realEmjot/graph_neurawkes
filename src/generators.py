...
# TODO reduce redundancy in this module

class NeurawkesGenerator:
    ...
    def generate_events(self, seed=None, max_events=None, max_time=None):  # TODO support for seed and self-links
        ...
        while (max_events is None or len(generated_sequence) < max_events) and \
            ...
            x_oh = tf.one_hot(event_type + 1, self.intensity_obj.num_types + 1)
...
class GraphNeurawkesGenerator:
    ...
    def generate_events(self, seed=None, max_events=None, max_time=None):  # TODO support for seed and self-links
        ...
        while (max_events is None or len(generated_sequence) < max_events) and \
            ...
            generated_sequence.append((current_sender, current_recipient, current_time.numpy()))
